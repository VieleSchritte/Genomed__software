...
from .formulas.base import LineFormatException, AllelesException, DelimitingFirst, TooManyDelimitingSymbols, UnknownSymbolInAlleles, DelimitingLast, LociSetDoesNotEqual, UnknownLocus
import json
...
родителя. Биологическое родство между проверяемыми детьми и известным родителем достоверно известно""",
    ...
    {
        'name': 'Ребенок и родительская пара',
        'desc': """
...
с которыми проверяется родство""",
    ...
    {
        'name': 'Двое детей и родительская пара',
        'desc': """
...
проверяемыми детьми""",
    ...
    {
        'name': 'Трое детей и родительская пара',
        'desc': """
...
исследования недоступен""",
    ...
    {
        'name': 'Предполагаемая бабушка/дедушка и внук/внучка',
        'desc': """
...
образцы предполагаемых родителей проверяемого лица для исследования недоступны""",
    ...
    {
        'name': 'Предполагаемая бабушка/дедушка и внук/внучка IBD',
        'desc': """
Исследованию подвергают биологические образцы проверяемого лица и предполагаемой бабушки(дедушки). Предполагается, 
что один из родителей проверяемого лица является дочерью или сыном предполагаемой бабушки (дедушки). Биологические 
образцы предполагаемых родителей проверяемого лица для исследования недоступны""",
...
недоступен""",
    ...
    {
        'name': 'Ребенок, предполагаемая бабушка/дедушка, предполагаемый родитель (потомок бабушки/дедушки)',
        'desc': """
    ...
    {
        'name': 'Ребенок, предполагаемая бабушка/дедушка, предполагаемый родитель (не потомок бабушки/дедушки)',
        'desc': """
...
предполагаемой бабушки/дедушки. Биологический образец этого второго родителя для исследования недоступен""",
    ...
    {
        'name': 'Проверяемое лицо, известный и предполагаемый родители, бабушка/дедушка',
        'desc': """
Исследованию подвергают биологические образцы проверяемого лица и предполагаемой бабушки(дедушки). Предполагается, 
что один из родителей проверяемого лица является дочерью или сыном предполагаемой бабушки (дедушки). Биологические 
образцы предполагаемых родителей проверяемого лица для исследования недоступны""",
        ...
        'value': 22,
        'participants_number': 4,
        'headers': ['Введите гаплотип проверяемого лица', 'Введите гаплотип известного родителя',
                    'Введите гаплотип предполагаемой бабушки/дедушки', 'Введите гаплотип предполагаемого родителя'],
    },
]
...
def calculate(request):
    ...
    try:
        ...
        return render(request, formula.get_template(), ctx)
            ...
            TooManyDelimitingSymbols, DelimitingLast, DelimitingFirst, LociSetDoesNotEqual, UnknownLocus) as exception:
