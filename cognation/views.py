...
formulas = [
    {
        ...
        'value': 1,
        'parts': [2, 'Введите гаплотип предполагаемого родителя', 'Введите гаплотип проверяемого лица'],
        'names': ['part1', 'part2']
    },
    {
        ...
        'value': 2,
        'parts': [3, 'Введите гаплотип предполагаемого родителя', 'Введите гаплотип первого проверяемого лица',
    ...
    которых для исследования недоступен""",
        ...
        'value': 3,
        'parts': [3, 'Введите гаплотип предполагаемого родителя', 'Введите гаплотип предполагаемого брата/сестры',
    ...
    образец второго родителя для исследования недоступен""",
        ...
        'value': 4,
        'parts': [4, 'Введите гаплотип предполагаемого родителя', 'Введите гаплотип первого проверяемого лица',
...
образец второго родителя для исследования недоступен""",
        ...
        'value': 5,
        'part_number': 4,
        'parts': [4, 'Введите гаплотип известного родителя', 'Введите гаплотип первого проверяемого лица',
...
родителя. Биологическое родство между проверяемыми детьми и известным родителем достоверно известно""",
        ...
        'value': 6,
        'parts': [5, 'Введите гаплотип известного родителя', 'Введите гаплотип первого проверяемого лица',
                  'Введите гаплотип второго проверяемого лица', 'Введите гаплотип третьего проверяемого лица',
                  'Введите гаплотип предполагаемого родителя'],
        'names': ['part1', 'part2', 'part3', 'part4', 'part5']
    },
    {
...
с которыми проверяется родство""",
        ...
        'value': 7,
        'parts': [3, 'Введите гаплотип предполагаемого отца', 'Введите гаплотип предполагаемой матери',
                  'Введите гаплотип проверяемого лица'],
        'names': ['part1', 'part2', 'part3'],
    },
    {
...
известным родителем достоверно известна""",
        ...
        'value': 8,
        'parts': [3, 'Введите гаплотип известного родителя', 'Введите гаплотип проверяемого лица',
                  'Введите гаплотип предполагаемого родителя'],
        'names': ['part1', 'part2', 'part3'],
    },
    {
...
проверяемыми детьми""",
        ...
        'value': 9,
        'parts': [4, 'Введите гаплотип предполагаемого отца', 'Введите гаплотип предполагаемой матери',
...
с которыми проверяется родство. Также достоверно известно биологическое родство между проверяемыми детьми""",
        ...
        'value': 10,
        'parts': [5, 'Введите гаплотип предполагаемого отца', 'Введите гаплотип предполагаемой матери',
                  'Введите гаплотип первого проверяемого лица', 'Введите гаплотип второго проверяемого лица',
...
братья/сестры, при условии, что у них общий отец или единоутробные - если у них общая мать""",
        'image': '',
        'value': 11,
        'parts': [2, 'Введите гаплотип проверяемого лица', 'Введите гаплотип единокровного/сводного брата/сестры'],
        'names': ['part1', 'part2'],
    },
    {
...
недоступны""",
        ...
        'value': 12,
        'parts': [2, 'Введите гаплотип проверяемого лица', 'Введите гаплотип предполагаемого брата/сестры'],
        'names': ['part1', 'part2'],
    },
    {
...
брата или сестры""",
        ...
        'value': 13,
        'parts': [3, 'Введите гаплотип проверяемого лица', 'Введите гаплотип первого предполагаемого брата/сестры',
...
исследования недоступны""",
        'image': '',
        'value': 14,
        'parts': [2, 'Введите гаплотип проверяемого лица', 'Введите гаплотип двоюродного брата/сестры'],
        'names': ['part1', 'part2'],
    },
    {
...
исследования недоступен""",
        'image': '',
        'value': 15,
        'parts': [2, 'Введите гаплотип проверяемого лица', 'Введите гаплотип предполагаемого дяди/тети'],
        'names': ['part1', 'part2'],
    },
    {
...
образцы предполагаемых родителей проверяемого лица для исследования недоступны""",
        ...
        'value': 17,
        'parts': [2, 'Введите гаплотип предполагаемой бабушки/дедушки', 'Введите гаплотип проверяемого лица'],
        'names': ['part1', 'part2'],
    },
    {
        'name': 'Проверяемое лицо и предполагаемая бабушка/дедушка',
...
образцы предполагаемых родителей проверяемого лица для исследования недоступны""",
        'image': '',
        'value': 19,
        'parts': [3, 'Введите гаплотип предполагаемой бабушки/дедушки', 'Введите гаплотип предполагаемого родителя',
                  'Введите гаплотип проверяемого лица'],
        'names': ['part1', 'part2', 'part3']
    }
]
...
def calculate(request):
    ...
    for formula_data in formulas:
        if formula_data['value'] == data_type:
            parts_data = formula_data['parts']
            participants_number = parts_data[0]

    participant1_data = request.POST.get('part1', '')
    print('=========participant1', participant1_data)
    participant2_data = request.POST.get('part2', '')
    print('=========participant2', participant2_data)
    participants_data = [participant1_data, participant2_data]

    if participants_number >= 3:
        participant3_data = request.POST.get('part3', '')
        participants_data.append(participant3_data)
    if participants_number >= 4:
        participant4_data = request.POST.get('part4', '')
        participants_data.append(participant4_data)
    if participants_number >= 5:
        participant5_data = request.POST.get('part5', '')
        participants_data.append(participant5_data)

    formula = formula_builder(data_type, participants_data, participants_number)
